...
17. ~~Port SD firmware update (SD_FW_Update) from SwiftOne~~ DONE — STM32U5 port: 8KB pages, dual-bank (Bank2 at 0x08040000), 128-bit quadword programming via FLASH_NSCR/NSSR/NSKEYR, 200KB image buffer in SRAM1, flash updater runs from flash with reverse page order, AIRCR reset. Needs hardware verification
